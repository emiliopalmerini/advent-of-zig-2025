...
test_day() {
    ...
    # Extract only the Part 1/2 lines (ignore Performance section)
    result=$(echo "$result" | grep -E "^Part [12]:" | head -2)
...
test_day 8 "Part 1: 57564
Part 2: 133296744" || ((FAILED++))
